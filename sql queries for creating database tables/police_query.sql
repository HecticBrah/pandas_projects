...
-- Convert case_id column into int value
...
-- Convert year_of_birth column into int value
ALTER TABLE police_data
ALTER COLUMN year_of_birth int NOT NULL;

-- Set driver_gender column as not null value
ALTER TABLE police_data
...
-- Convert driver_age column into tinyint value
ALTER TABLE police_data
ALTER COLUMN driver_age tinyint NOT NULL;

-- Set driver_race column as not null
ALTER TABLE police_data
ALTER COLUMN driver_race VARCHAR(25) NOT NULL;

-- Convert stop_time column into char value and set it as not null
ALTER TABLE police_data
ALTER COLUMN stop_time char(5) NOT NULL;

-- Set violation_raw column as not null
ALTER TABLE police_data
ALTER COLUMN violation_raw VARCHAR(100) NOT NULL;

-- Set violation column as not null
ALTER TABLE police_data
ALTER COLUMN violation VARCHAR(50) NOT NULL;

-- Set search_conducted column as char and not null
ALTER TABLE police_data
ALTER COLUMN search_conducted CHAR(10) NOT NULL;

-- Set search_type column as  not null
ALTER TABLE police_data
ALTER COLUMN search_type VARCHAR(150) NOT NULL;

-- Set stop_outcome column as not null
ALTER TABLE police_data
ALTER COLUMN stop_outcome VARCHAR(100) NOT NULL;

-- Set is_arrested column as varchar and not null
ALTER TABLE police_data
ALTER COLUMN is_arrested VARCHAR(50) NOT NULL;

-- Set stop_duration column as varchar and not null
ALTER TABLE police_data
ALTER COLUMN stop_duration VARCHAR(50) NOT NULL;

-- Set drugs_related_stop column as char and not null
ALTER TABLE police_data
ALTER COLUMN drugs_related_stop CHAR(10) NOT NULL;

-- Convert stopped_by column into int value
ALTER TABLE police_data
...
-- Adding a new column of datetime type value
ALTER TABLE police_data
ADD stop_date_and_time DATETIME;

-- Updating the new column with combined values from stop_date and stop_time columns
UPDATE police_data
...
-- Setting stop_date_and_time column as not null
ALTER TABLE police_data
