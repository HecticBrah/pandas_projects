...
-- Set stopped_at column as not null
ALTER TABLE police_data
ALTER COLUMN stopped_at VARCHAR(25)  NOT NULL;
...
-- Convert stop_duration_in_minutes column into int
ALTER TABLE police_data
ALTER COLUMN stop_duration_in_minutes int NOT NULL;

-- Set violation column as  not null
ALTER TABLE police_data
ALTER COLUMN violation VARCHAR(100) NOT NULL;
...
ALTER TABLE police_data
ALTER COLUMN search_type VARCHAR(250) NOT NULL;
...
UPDATE police_data
SET stop_date_and_time = CONVERT(DATETIME, CONVERT(DATETIME, stop_date) + ' ' + CONVERT(CHAR, stopped_at));
